                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()){
                                    ...
                                    .setValue(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()){
                                                ...
                                                Toast.makeText(RegisterActivity.this,"failed to register user please check internet connection and try again",Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(RegisterActivity.this,"failed to register user check internet connection and details",Toast.LENGTH_SHORT).show();
                            progressBar.setVisibility(View.GONE);
